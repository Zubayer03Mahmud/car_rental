...
const Testimonial = () => {
      ...
      const testimonials = [
        { name: "Sanseii Roy",
          location: "Dhaka, Bangladesh", image: assets.testimonial_image_1 ,
          testimonial: "I've rented cars from various companies, but the experience with CarRental was exceptional." 
        },
         { name: "Sophia Lee",
          location: "Sydney,Australia", image: assets.testimonial_image_2 ,
          testimonial: "CarRental made my trip so much easier with their wide selection of vehicles and excellent customer service." 
        },
         { name: "Jennifer Smith",
          location: "New York, USA", image: assets.testimonial_image_1 ,
